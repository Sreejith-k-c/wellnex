...
class MeditationFocus extends StatefulWidget {
  @override
  _MeditationFocusState createState() => _MeditationFocusState();
}

class _MeditationFocusState extends State<MeditationFocus> {
  final int meditationDuration = 5;
            ...
            children: [
              Padding(
                ...
                child: Container(
                    height: 260,
                    child: Lottie.asset(
                        "assets/lottie_animations/Animation - 1709717661975.json")),
              ),
              SizedBox(height: 20),
              Text(
