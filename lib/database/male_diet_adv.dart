class AdvancedDiet {
  static List<Map<String, dynamic>> dietPlanAdva = [
    {
      'day': 'Day 1:',
      'meals': [
        'Breakfast: Protein oatmeal made with oats, protein powder, almond milk, and topped with sliced almonds and berries.',
    ...
    },
    {
      'day': 'Day 3:',
      'meals': [
        'Breakfast: Protein smoothie with spinach, kale, banana, protein powder, and almond milk.',
        'Snack: Greek yogurt with mixed nuts and a drizzle of honey.',
    ...
    },
    {
      'day': 'Day 5:',
      'meals': [
        'Breakfast: Greek yogurt parfait with granola, mixed berries, and a scoop of protein powder.',
        'Snack: Turkey slices wrapped around cucumber sticks with hummus.',
    ...
    },
    {
      'day': 'Day 6:',
      'meals': [
        'Breakfast: Egg white omelet with spinach, tomatoes, mushrooms, and feta cheese.',
        'Snack: Cottage cheese with sliced mango and a sprinkle of cinnamon.',
    ...
    },
    {
      'day': 'Day 7:',
      'meals': [
        'Breakfast: Protein smoothie bowl topped with granola, sliced banana, and a drizzle of almond butter.',
        'Snack: Greek yogurt with mixed nuts and a sprinkle of dark chocolate chips.',
