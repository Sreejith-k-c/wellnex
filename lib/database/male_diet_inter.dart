class IntermediateDiet {
  static List<Map<String, dynamic>> dietPlaninter = [
    {
      'day': 'Day 1:',
      'meals': [
        'Breakfast: Scrambled eggs (3 eggs) with spinach and whole wheat toast.',
        'Snack: Greek yogurt (1 cup) with berries.',
    ...
    },
    {
      'day': 'Day 2:',
      'meals': [
        'Breakfast: Oatmeal (1 cup cooked) topped with sliced banana and almonds (1/4 cup).',
    ...
    },
    {
      'day': 'Day 3:',
      'meals': [
        'Breakfast: Whole grain cereal (1 cup) with skim milk (1 cup) and sliced strawberries (1/2 cup).',
        'Snack: Handful of mixed nuts (1/4 cup).',
    ...
    },
    {
      'day': 'Day 4:',
      'meals': [
        'Breakfast: Protein smoothie made with spinach, banana, protein powder, and almond milk (1 cup).',
        'Snack: Cottage cheese (1/2 cup) with sliced peaches.',
    ...
    },
    {
      'day': 'Day 5:',
      'meals': [
        'Breakfast: Greek yogurt (1 cup) parfait with granola (1/4 cup) and mixed berries (1/2 cup).',
        'Snack: Handful of trail mix (1/4 cup).',
    ...
    },
    {
      'day': 'Day 6:',
      'meals': [
        'Breakfast: Whole grain toast with avocado slices (1/2) and poached eggs (2).',
    ...
    },
    {
      'day': 'Day 7:',
      'meals': [
        'Breakfast: Veggie omelet (3 eggs) with whole wheat toast.',
        'Snack: Cottage cheese (1/2 cup) with pineapple chunks.',
